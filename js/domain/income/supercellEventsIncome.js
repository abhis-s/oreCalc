...
/**
 * Calculates ore income from official Supercell livestream tournaments (Monthly Finals, LCQ, World Finals).
 *
 * @param {boolean} [isWorldChampionshipEnabled=false] - Whether Supercell event streams rewards are enabled.
 * @param {{ globalOverride?: boolean, shiny?: number, glowy?: number, starry?: number } | null} [scOverride=null] - Optional manual override ore amounts.
 * @returns {import('../../core/types.js').IncomeResult} Composite supercell events income rates.
 */
export function calculateSupercellEventsIncome(isWorldChampionshipEnabled, scOverride = null) {
