export const heroData = {
    barbarianKing: {
        ...
        equipment: [
            ...
            { key: "giantGauntlet", name: "Giant Gauntlet", type: "epic", image: "assets/equipment/barbarian_king/BK_giant_gauntlet.png", heroJourneyNode: 20 },
            { key: "spikyBall", name: "Spiky Ball", type: "epic", image: "assets/equipment/barbarian_king/BK_spiky_ball.png", heroJourneyNode: 180 },
            { key: "snakeBracelet", name: "Snake Bracelet", type: "epic", image: "assets/equipment/barbarian_king/BK_snake_bracelet.png", heroJourneyNode: 452 },
            { key: "stickHorse", name: "Stick Horse", type: "epic", image: "assets/equipment/barbarian_king/BK_stick_horse.png" },
        ],
    },
    archerQueen: {
        key: "archerQueen",
        ...
        equipment: [
            ...
            { key: "frozenArrow", name: "Frozen Arrow", type: "epic", image: "assets/equipment/archer_queen/AQ_frozen_arrow.png", heroJourneyNode: 50 },
            { key: "magicMirror", name: "Magic Mirror", type: "epic", image: "assets/equipment/archer_queen/AQ_magic_mirror.png", heroJourneyNode: 203 },
            { key: "actionFigure", name: "Action Figure", type: "epic", image: "assets/equipment/archer_queen/AQ_action_figure.png" },
            { key: "monolithArrow", name: "Monolith Arrow", type: "epic", image: "assets/equipment/archer_queen/AQ_monolith_arrow.png" },
        ],
    },
    minionPrince: {
        key: "minionPrince",
        ...
        equipment: [
            ...
            { key: "darkCrown", name: "Dark Crown", type: "epic", image: "assets/equipment/minion_prince/MP_dark_crown.png", heroJourneyNode: 99 },
            { key: "meteorStaff", name: "Meteor Staff", type: "epic", image: "assets/equipment/minion_prince/MP_meteor_staff.png", heroJourneyNode: 302 },
        ],
    },
    grandWarden: {
        key: "grandWarden",
        ...
        equipment: [
            ...
            { key: "fireball", name: "Fireball", type: "epic", image: "assets/equipment/grand_warden/GW_fireball.png", heroJourneyNode: 150 },
            { key: "lavaloonPuppet", name: "Lavaloon Puppet", type: "epic", image: "assets/equipment/grand_warden/GW_lavaloon_puppet.png", heroJourneyNode: 354 },
            { key: "heroicTorch", name: "Heroic Torch", type: "epic", image: "assets/equipment/grand_warden/GW_heroic_torch.png" },
        ],
    },
    royalChampion: {
        key: "royalChampion",
        ...
        equipment: [
            ...
            { key: "rocketSpear", name: "Rocket Spear", type: "epic", image: "assets/equipment/royal_champion/RC_rocket_spear.png", heroJourneyNode: 250 },
            { key: "electroBoots", name: "Electro Boots", type: "epic", image: "assets/equipment/royal_champion/RC_electro_boots.png", heroJourneyNode: 425 },
            { key: "frostFlake", name: "Frost Flake", type: "epic", image: "assets/equipment/royal_champion/RC_frost_flake.png" },
        ],
    },
    dragonDuke: {
        key: "dragonDuke",
...
export function getHeroEpicEquipmentPool(heroKey) {
    ...
    return hero.equipment
        .filter(eq => eq.type === 'epic' && eq.key !== 'comingSoon' && eq.name !== 'Coming Soon')
        .map(eq => ({
            key: eq.key,
            name: eq.name,
            icon: eq.image,
